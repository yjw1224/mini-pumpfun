          ...
          <div className="space-y-6">
            <Card>
              <div className="grid gap-5 sm:grid-cols-2">
                ...
                <div><p className="text-[13px] text-text-secondary">Market Cap</p><p className="mt-1 font-financial text-xl text-text-primary">{formatUsd((price * (maxTokenSupply ?? 0n)) / 10n ** 18n, 0)}</p></div>
              </div>
            </Card>
            <Card>
